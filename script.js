const subscribe_form = document.getElementById("subscribe-form");
...
//   console.log("test");
//   // cart_display.innerHTML = createTable();
//   // cart_dialog.showModal();
// });
const btn = document.getElementById("view-cart");
console.log("Button is", view_cart_button);
view_cart_button.addEventListener("click", () => {
  alert("Clicked!");
});
// clear_cart_button.addEventListener("click", () => clearCart(cart))
// process_order_button.addEventListener("click", () => processCart(cart))
